...
type PostRepository interface {
	...
	GetPostByMentionWithPagination(middlewares.UserAuth, requests.GetPostByMentionWithPaginationRequest) (posts []models.Post, amountPage int64, ex exceptions.CommonExceptionInterface)
